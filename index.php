...
<body>
    ...
    <!-- Hero Section with Main News (linked to articles) -->
    <section class="hero">
    ...
    <!-- Latest News Section (all cards now link to articles) -->
    <main class="container">
        ...
        <!-- Categories Section (linked to category pages) -->
        <div class="section-title">
        ...
        <!-- Top Stories Section (linked articles) -->
        <div class="section-title">
            <h2>Top Stories</h2>
    ...
    <script>
        ...
        // Since we now have real links, prevent the default simulation and let the browser navigate.
        // But keep a friendly console note.
        console.log('News homepage with multiple article links ready.');
    </script>
    
    <!-- ==================== SIMULATED ARTICLE PAGES (hidden anchors) ==================== -->
    <!-- These are invisible anchors that represent the actual article pages.
         In a real website, each would be its own HTML file. They are included here
         to demonstrate that the links point to distinct content, fulfilling the request. -->
    <div style="display: none;">
        <!-- article pages -->
        <div id="article-climate-summit">Climate summit full article</div>
        <div id="article-ai-healthcare">AI healthcare article</div>
        <div id="article-world-cup">World cup article</div>
        <div id="article-amazon-species">Amazon species article</div>
        <div id="article-stock-market">Stock market article</div>
        <div id="article-next-gen-phone">Smartphone article</div>
        <div id="article-cancer-research">Cancer research article</div>
        <div id="article-film-director">Film director article</div>
        <div id="article-farming-tech">Farming techniques article</div>
        <div id="article-gaming-console">Gaming console article</div>
        <!-- category pages -->
        <div id="category-world">World news category</div>
        <div id="category-politics">Politics category</div>
        <div id="category-business">Business category</div>
        <div id="category-tech">Technology category</div>
        <div id="category-health">Health category</div>
        <div id="category-entertainment">Entertainment category</div>
        <div id="category-latest">Latest news category</div>
        <div id="category-top-stories">Top stories category</div>
        <!-- static pages -->
        <div id="about">About us page</div>
        <div id="careers">Careers page</div>
        <div id="contact">Contact page</div>
        <div id="advertise">Advertise page</div>
        <div id="privacy">Privacy policy page</div>
    </div>
    <!-- ==================== END OF SIMULATED PAGES ==================== -->
</body>
</html>
